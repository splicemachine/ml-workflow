...
public abstract class AbstractRunner {
    ...
    public abstract Queue<ExecRow> predictRegression(Queue<ExecRow> rows, List<Integer> modelFeaturesIndexes,int predictionColIndex, List<String> featureColumnNames) throws IllegalAccessException, StandardException, InvocationTargetException, PredictException;
    ...
    public abstract Queue<ExecRow> predictKeyValue(Queue<ExecRow> rows, List<Integer> modelFeaturesIndexes, List<String> predictionLabelIndexes, List<String> featureColumnNames, String predictCall, String predictArgs, double threshold) throws PredictException, IllegalAccessException, StandardException, InvocationTargetException;
