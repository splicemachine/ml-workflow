    ...
    MAPPING: dict = {
        ...
        HandlerNames.deploy_k8s: Handler(
            payload_args=[
                ...
                Field('autoscaling_enabled', use_default=True, default=False,
                      callback=Field.string_to_boolean_converter, callback_on=str),
                Field('max_replicas', use_default=True, default=2),
                Field('target_cpu_utilization', use_default=True, default=50),
                Field('disable_nginx', default=False, use_default=True, callback=Field.string_to_boolean_converter,
                      callback_on=str),
                ...
                Field('resource_requests_enabled', default=False, callback=Field.string_to_boolean_converter,
                      callback_on=str, use_default=True),
                ...
                Field('expose_external', use_default=True, default=False, callback=Field.string_to_boolean_converter,
                      callback_on=str)
            ],
