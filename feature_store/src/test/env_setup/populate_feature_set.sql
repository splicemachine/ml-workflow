INSERT INTO retail_fs.customer_lifetime_v1
...
INSERT INTO RETAIL_FS.CUSTOMER_RFM_BY_CATEGORY_v1
(
        CUSTOMERID, 
        LAST_UPDATE_TS, 
...
WHERE NOT EXISTS ( SELECT 1 FROM RETAIL_FS.CUSTOMER_RFM_BY_CATEGORY_v1 WHERE CUSTOMERID=y.CUSTOMERID);
